...
| Model | Groq — `llama-3.3-70b-versatile` | Free tier, fast enough for interactive use in the UI |
...
├── requirements.txt
├── .gitignore
└── learning_phase/   # Earlier Agno practice (see its own README)
...
```bash
git clone https://github.com/Krishna-Yadav500/agentic-ai-youtube-analyzer.git
...
Krishna Yadav — BTech. CSE, PSIT Kanpur
[GitHub](https://github.com/Krishna-Yadav500) · [LinkedIn](https://www.linkedin.com/in/krishna-yadav-63a0a5331) 
